https://docs.claude.com/en/docs/agents-and-tools/tool-use/overview.md

# Tool use with Claude

* Claude
  * can extend their capabilities
    * by interacting -- with -- tools & functions 

* recommendations
  * use strict tool 
    * `strict: true` | your tool definitions
    * -> Claude's tool calls ALWAYS match your schema exactly
      * == schema conformance 
      * exactly != type mismatches OR missing fields
    * use cases
      * production agents
        * Reason: invalid tool parameters -> would cause failures
      * [MORE](build-with-claude._structured-outputs.md#when-to-use-json-outputs-vs-strict-tool-use)

* [Structured Outputs](build-with-claude._structured-outputs.md)
  * provides
    * | tool inputs, guaranteed schema validation
